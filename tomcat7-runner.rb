class TomcatRunner < Formula
  ...
  url "http://repo1.maven.org/maven2/com/github/jsimone/webapp-runner/7.0.57.2/webapp-runner-7.0.57.2.jar"
  version "7.0.57.2"
  ...
  def install
    ...
    bin.mkpath
    bin.write_jar_script libexec/"tomcat-runner-#{version}.jar", "tomcat7-runner"
  end
end
